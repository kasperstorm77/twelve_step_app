...
class InventoryEntry extends HiveObject {
  ...
  List<String> get effectiveIAmIds =>
      iAmIds ??
      (_iAmId != null && _iAmId!.isNotEmpty && _iAmId != 'null'
          ? [_iAmId!]
          : []);

  /// Get the effective category (defaults to resentment for backward compatibility)
  InventoryCategory get effectiveCategory =>
  ...
  Map<String, dynamic> toJson() {
    final firstIAmId =
        iAmId; // Uses getter which returns first from iAmIds or legacy _iAmId
    ...
    return {
      ...
      if (category != null)
        'category': category!.name, // Store as string for JSON compatibility
    };
  }
  ...
  factory InventoryEntry.fromJson(Map<String, dynamic> json) {
    ...
    final String? parsedIAmId = (iAmIdValue == null || iAmIdValue == 'null')
        ? null
        : iAmIdValue as String?;
    ...
    if (json['category'] != null) {
      ...
      parsedCategory = InventoryCategory.values
