...
class AppVersionService {
  ...
  static Future<bool> isNewInstallOrUpdate() async {
    ...
    if (kDebugMode) {
      print(
        'AppVersionService: Current version: $currentVersion, Stored version: $storedVersion',
      );
    }
    ...
    if (storedVersion != currentVersion) {
      ...
      if (kDebugMode) {
        print(
          'AppVersionService: Detected app update from $storedVersion to $currentVersion',
        );
      }
      return true;
    }
  ...
  static Future<bool> isUpdate() async {
    ...
    return storedVersion !=
        null; // If there was a stored version, it's an update
  }
