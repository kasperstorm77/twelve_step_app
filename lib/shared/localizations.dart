...
final Map<String, Map<String, String>> localizedValues = {
  'en': {
    ...
    'fetch_success_count': 'Restored: %entries% inventory, %iams% I Am, %people% people, %reflections% reflections, %gratitude% gratitude, %agnosticism% barriers, %ritualItems% ritual items, %ritualEntries% ritual entries',
    ...
    'import_success_count': 'Restored: %entries% inventory, %iams% I Am, %people% people, %reflections% reflections, %gratitude% gratitude, %agnosticism% barriers, %ritualItems% ritual items, %ritualEntries% ritual entries',
    ...
    'agnosticism_barriers_title': 'Not given to god',
    'agnosticism_powers_title': 'God-given corrective attitude',
  ...
  'da': {
    ...
    'fetch_success_count': 'Gendannet: %entries% inventar, %iams% Jeg er, %people% personer, %reflections% refleksioner, %gratitude% taknemmelighed, %agnosticism% barrierer, %ritualItems% ritual elementer, %ritualEntries% ritual indtastninger',
    ...
    'import_success_count': 'Gendannet: %entries% inventar, %iams% Jeg er, %people% personer, %reflections% refleksioner, %gratitude% taknemmelighed, %agnosticism% barrierer, %ritualItems% ritual elementer, %ritualEntries% ritual indtastninger',
    // Language names (keep as-is, these are proper nouns)
    'lang_english': 'English',
    'lang_danish': 'Dansk',
    // 8th Step Amends
    ...
    'add': 'Tilføj',
    // Agnosticism (Danish)
    'agnosticism_title': 'Agnosticisme',
    ...
    'agnosticism_power_hint': 'Hvilken gudsgivet holdning korrigerer dette?',
    ...
    'help_agnosticism_purpose': 'Dette værktøj hjælper med at identificere hvad vi stadig holder fast i i stedet for at overgive det til gud, og de gudsgivne korrigerende holdninger der erstatter vores defekter. Det er en praktisk anvendelse af trin 3 - at overlade vores vilje og liv til guds omsorg.',
    ...
    'help_agnosticism_powers': 'For hver ting der ikke er overgivet, identificer den gudsgivne holdning der korrigerer den: accept i stedet for kontrol, tillid i stedet for frygt, ydmyghed i stedet for stolthed, taknemmelighed i stedet for vrede, tro i stedet for bekymring.',
