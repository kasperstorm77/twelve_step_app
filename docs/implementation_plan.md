...
### P1.1 Grant the Play service account "Manage store presence"
...
### P1.2 Replace the Play screenshots — DONE for the App Store
...
the same edit-commit that P1.1 blocks. Regenerate and upload once that
