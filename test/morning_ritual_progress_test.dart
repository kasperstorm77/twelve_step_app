...
void main() {
  ...
  group('MorningRitualService progress draft', () {
    test(
      'round-trips an in-progress ritual saved earlier the same day',
      () async {
        ...
        final loaded = MorningRitualService.loadProgress(
    ...
    test(
      'a draft from a previous day is treated as stale and discarded',
      () async {
        await MorningRitualService.saveProgress(
